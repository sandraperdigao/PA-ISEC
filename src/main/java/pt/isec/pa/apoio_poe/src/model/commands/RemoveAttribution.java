...
public class RemoveAttribution extends CommandAdapter {
    Student studentToAttribute;
    ProposalAdapter proposalToAttribute;

    public RemoveAttribution(ProposalAttributionManager paMan, SupervisorAttributionManager saMan, Student tempStudent, ProposalAdapter tempProposal) {
        super(paMan, saMan);
